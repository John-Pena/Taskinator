...
var taskFormHandler = function(event) {
    ...
    // no data attribute, so create object as normal and pass the createTaskEl function
    else {
...
var createTaskEl = function(taskDataObj) {
    ...
    // adding saveTasks() function to save to local storage
    saveTasks();
};
...
var completeEditTask = function(taskName, taskType, taskId) {
    ...
    for (var i = 0; i < tasks.length; i++) {
        // if statement converts taskId to a number, from a string, to allow a comparison between the number identified as tasks[i]
        // parseInt() function converts strings to number
